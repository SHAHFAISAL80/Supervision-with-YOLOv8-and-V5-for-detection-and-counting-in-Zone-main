...
model = YOLO(r'E:\crowd counting\Tkinter-with-YOLO-python-to-exe-computer-vision-main\yolov8s.pt')
video_paused = False
...
class_list = read_classes_from_file(r'E:\crowd counting\Tkinter-with-YOLO-python-to-exe-computer-vision-main\coco.txt')
...
initial_image = Image.open(r'E:\crowd counting\Tkinter-with-YOLO-python-to-exe-computer-vision-main\yolo.jpg')  # Replace 'initial_image.jpg' with your image path
